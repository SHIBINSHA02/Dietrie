  ...
  const nutritionistFeatures = [
    {
      ...
      description:
        "Efficiently manage client profiles, track progress, and communicate seamlessly.",
    },
    {
      ...
      description:
        "Streamline your scheduling process with our integrated appointment system.",
    },
    {
      ...
      description:
        "Create and share personalized meal plans and resources with your clients.",
    },
  ];
    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <p className="text-[#0e1b0e] text-base font-normal leading-normal max-w-[720px]">
          Expand your reach and manage your clients effectively with our
