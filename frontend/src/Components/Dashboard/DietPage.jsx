            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-l-blue-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-600">87g</p>
                  <p className="text-xs text-green-600">Goal: 120g</p>
                </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-sm border-l-4 border-l-orange-500">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-orange-600">245g</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-gray-200 rounded-full h-3">
                    <div className="bg-purple-500 h-3 rounded-full" style={{width: '73%'}}></div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm p-6">
              ...
              <div className="space-y-3">
                <button className="w-full text-left p-3 border border-gray-200 rounded-lg hover:bg-gray-50 flex items-center gap-2">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Oatmeal with berries and honey</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-medium">420 kcal</p>
              ...
              <div className="flex items-center justify-between p-4 bg-blue-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium">580 kcal</p>
              ...
              <div className="flex items-center justify-between p-4 bg-orange-50 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-medium">180 kcal</p>
                  <p className="text-xs text-gray-500">3:20 PM</p>
                </div>
              </div>
            </div>
          </div>
