    ...
    <header className="flex items-center stretch fixed w-full z-20 justify-between whitespace-nowrap border-b border-solid border-b-[#e7f3e7] px-4 sm:px-6 lg:px-10 py-3 bg-white">
      ...
      >
        <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 lg:gap-8">
          <a onClick={handleLinkClick} className="nav-link" href="#">Home</a>
          <a onClick={handleLinkClick} className="nav-link" href="#for-users-section">For Users</a>
          <a onClick={handleLinkClick} className="nav-link" href="#for-nutritionists-section">For Nutritionists</a>
          <a onClick={handleLinkClick} className="nav-link" href="#">Resources</a>
        </div>
